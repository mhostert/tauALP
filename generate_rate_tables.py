...
ICARUS = exp.Experiment(NUMI_files, exp_dic=EXPERIMENTS["ICARUS"], duplicate_taus=5)
MICROBOONE = exp.Experiment(
    NUMI_files, exp_dic=EXPERIMENTS["MicroBooNE"], duplicate_taus=10
)
NOVA = exp.Experiment(NUMI_files, exp_dic=EXPERIMENTS["NoVA"], duplicate_taus=5)
...
if __name__ == "__main__":
    ...
    #     BP_NAME = f"hierarchy_lambda_{lam}_clep_1_jul10"
    #     lamb = lam
    #     C_LEPTON = 1

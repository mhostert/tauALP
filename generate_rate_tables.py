...
ICARUS = exp.Experiment(NUMI_files, exp_dic=EXPERIMENTS["ICARUS"], duplicate_taus=10)
MICROBOONE = exp.Experiment(
    NUMI_files, exp_dic=EXPERIMENTS["MicroBooNE"], duplicate_taus=20
)
NOVA = exp.Experiment(NUMI_files, exp_dic=EXPERIMENTS["NoVA"], duplicate_taus=3)

DUNE = exp.Experiment(NUMI_files, exp_dic=EXPERIMENTS["DUNE"], duplicate_taus=1)
...
if __name__ == "__main__":
    ...
    exp_list = [CHARM, BEBC, SHIP, FASER2, PROTODUNE_NP02, PROTODUNE_NP04]
    run_simulations(exp_list, BP_NAME, **kwargs)

    exp_list = [DUNE, PROTODUNE_NP02, PROTODUNE_NP04]
    run_simulations(exp_list, BP_NAME, **kwargs)
    ...
    exp_list = [CHARM, BEBC, SHIP, FASER2]
    run_simulations(exp_list, BP_NAME, **kwargs)
